...
const Skills = () => {
    ...
    return (
    <div name='listenHome' className='w-full h-screen sm:h-[70vh] bg-hero-listen text-white bg-cover bg-fixed '>
        <div className='flex mx-auto h-full items-center justify-center p-0 pt-8 sm:pl-28'>
